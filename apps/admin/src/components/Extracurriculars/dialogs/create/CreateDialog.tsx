...
import {
  createExtraCurricularRequestSchema,
  type CreateExtraCurricularReq,
} from '@repo/contracts/schemas/extraCurricular/createExtraCurricularRequest';
...
const CreateDialog = () => {
  ...
  const { mutateAsync, isPending } = useMutation({
    mutationKey: ['extracurriculars', 'create'],
  ...
  const form = useForm<CreateExtraCurricularReq>({
    resolver: zodResolver(createExtraCurricularRequestSchema),
