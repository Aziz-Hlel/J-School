    ...
    <div className={cn('w-full max-w-4xl', className)}>
      ...
      >
        <CardContent className='text-center'>
          ...
          <h3 className='text-2sm text-foreground mb-0.5 font-medium'>Choose a file or drag & drop here.</h3>
                ...
                <div className='flex w-full flex-col gap-1.5'>
                  <div className='-mt-2 flex w-full items-center justify-between gap-2.5'>
                    <div className='flex items-center gap-2.5'>
                      <span className='text-foreground text-xs leading-none font-medium'>{imageFile.file.name}</span>
                      <span className='text-muted-foreground text-xs leading-none font-normal'>
                        {formatBytes(imageFile.file.size)}
                      </span>
                      {imageFile.status === 'uploading' && (
                        <p className='text-muted-foreground text-xs'>Uploading... {Math.round(imageFile.progress)}%</p>
                      )}
                    </div>
